...
# define execstate_derive_padlist(a)            Perl_execstate_derive_padlist(aTHX_ a)
# define execstate_destroy()                    Perl_execstate_destroy(aTHX)
# define execstate_free_padlist(a)              Perl_execstate_free_padlist(aTHX_ a)
# define execstate_init(a)                      Perl_execstate_init(aTHX_ a)
# define execstate_load(a)                      Perl_execstate_load(aTHX_ a)
# define execstate_save(a)                      Perl_execstate_save(aTHX_ a)
...
# define savestack_freeze(a)                    Perl_savestack_freeze(aTHX_ a)
# define savestack_frozen_foreach_sv(a,b,c)     Perl_savestack_frozen_foreach_sv(aTHX_ a,b,c)
# define savestack_frozen_free(a)               Perl_savestack_frozen_free(aTHX_ a)
# define savestack_frozen_run_deferred(a)       Perl_savestack_frozen_run_deferred(aTHX_ a)
# define savestack_grow()                       Perl_savestack_grow(aTHX)
# define savestack_grow_cnt(a)                  Perl_savestack_grow_cnt(aTHX_ a)
# define savestack_thaw(a)                      Perl_savestack_thaw(aTHX_ a)
